    ...
    <div class="category-page">
      <div class="category-header">
        <div class="container">
          ...
          <h1>Aşılar</h1>
          <p>Çocukluk çağı aşıları hakkında detaylı bilgi föyleri ve rehberler</p>
          <div class="stats">
            <div class="stat-item">
          ...
          <div class="doc-grid">
            <a *ngFor="let doc of docs" class="doc-card" [routerLink]="doc.path">
              <div class="doc-card-header">
                ...
                <div class="doc-meta">
                  <div class="doc-category">Aşılar</div>
                  <div class="doc-type">Bilgi Föyü</div>
                </div>
              </div>
              <div class="doc-card-body">
                <h3 class="doc-title">{{ doc.title }}</h3>
                <p class="doc-description">Aşı hakkında önemli bilgiler ve yan etkiler</p>
              </div>
...
export class AsilarCategoryComponent implements OnInit {
  docs: ResourceLink[] = RESOURCES_INDEX['asilar'] || [];
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({ name: 'keywords', content: 'aşılar, çocuk aşıları, HPV, influenza, KKK, meningokok, rotavirüs' });
  }
}
