...
@Component({
  ...
  templateUrl: './kkk-a-s-bilgi-f-y.component.html',
  styleUrl: './kkk-a-s-bilgi-f-y.component.css'
})
export class KkkASBilgiFYComponent implements OnInit, AfterViewInit {
  title = 'KKK Aşısı Bilgi Föyü';
  category = 'Aşılar';
  description: string = "THE IMMUNIZATION ACTION COALITION (IAC) AŞI BİLGİ FÖYÜ KIZAMIK - KIZAMIKÇIK - KABAKULAK (KKK) AŞISI Neden Aşı Olalım? KKK aşısı kızamık, kabakulak ve kızamıkçığı önleyebilir. KIZA…";
