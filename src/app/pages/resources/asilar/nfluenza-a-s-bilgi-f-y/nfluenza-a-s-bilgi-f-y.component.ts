...
@Component({
  ...
  templateUrl: './nfluenza-a-s-bilgi-f-y.component.html',
  styleUrl: './nfluenza-a-s-bilgi-f-y.component.css'
})
export class NfluenzaASBilgiFYComponent implements OnInit, AfterViewInit {
  title = 'İnfluenza Aşısı Bilgi Föyü';
  category = 'Aşılar';
  description: string = "THE IMMUNIZATION ACTION COALITION (IAC) AŞI BİLGİ FÖYÜ İNFLUENZA AŞISI Neden Aşı Olalım? İnfluenza aşısı influenzayı (grip) önleyebilir. Grip her yıl genellikle ekim ve mayıs ayla…";
