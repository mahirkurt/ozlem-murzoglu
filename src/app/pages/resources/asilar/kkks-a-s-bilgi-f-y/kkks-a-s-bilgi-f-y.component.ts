...
@Component({
  ...
  templateUrl: './kkks-a-s-bilgi-f-y.component.html',
  styleUrl: './kkks-a-s-bilgi-f-y.component.css'
})
export class KkksASBilgiFYComponent implements OnInit, AfterViewInit {
  title = 'KKKS Aşısı Bilgi Föyü';
  category = 'Aşılar';
  description: string = "THE IMMUNIZATION ACTION COALITION (IAC) AŞI BİLGİ FÖYÜ KIZAMIK - KIZAMIKÇIK - KABAKULAK - VARİSELLA (KKKV) AŞISI Neden Aşı Olalım? MMRV aşısı kızamık, kabakulak, kızamıkçık ve var…";
