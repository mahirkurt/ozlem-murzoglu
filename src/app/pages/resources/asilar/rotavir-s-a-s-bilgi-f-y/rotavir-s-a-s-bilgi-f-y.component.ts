...
@Component({
  ...
  templateUrl: './rotavir-s-a-s-bilgi-f-y.component.html',
  styleUrl: './rotavir-s-a-s-bilgi-f-y.component.css'
})
export class RotavirSASBilgiFYComponent implements OnInit, AfterViewInit {
  title = 'Rotavirüs Aşısı Bilgi Föyü';
  category = 'Aşılar';
  description: string = "THE IMMUNIZATION ACTION COALITION (IAC) AŞI BİLGİ FÖYÜ ROTAVİRÜS AŞISI Neden Aşı Olalım? Rotavirüs aşısı rotavirüs hastalığını önleyebilir. Rotavirüs genellikle bebeklerde ve küçü…";
