...
@Component({
  ...
  templateUrl: './meningokok-b-a-s-bilgi-f-y.component.html',
  styleUrl: './meningokok-b-a-s-bilgi-f-y.component.css'
})
export class MeningokokBASBilgiFYComponent implements OnInit, AfterViewInit {
  title = 'Meningokok B Aşısı Bilgi Föyü';
  category = 'Aşılar';
  description: string = "THE IMMUNIZATION ACTION COALITION (IAC) AŞI BİLGİ FÖYÜ MENİNGOKOK B AŞISI Neden Aşı Olalım? Meningokok B aşısı serogrup B'nin neden olduğu meningokok hastalığına karşı korunmaya y…";
