...
@Component({
  selector: 'app-1-ya-oyuncak-k-lavuzu',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './1-ya-oyuncak-k-lavuzu.component.html',
  styleUrl: './1-ya-oyuncak-k-lavuzu.component.css'
})
export class Doc1YaOyuncakKLavuzuComponent implements OnInit, AfterViewInit {
  title = '1 Yaş - Oyuncak Kılavuzu';
  category = 'Oyuncaklar';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ OYUNCAK KILAVUZU 1 YAŞ Büyük resimler ve basit hikayeler içeren karton sayfalı kitaplar Bebek fotoğrafları içeren kitaplar ve dergiler Bloklar İç içe g…";
