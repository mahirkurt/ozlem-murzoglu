...
@Component({
  ...
  templateUrl: './1-ya-geli-imsel-neriler.component.html',
  styleUrl: './1-ya-geli-imsel-neriler.component.css'
})
export class Doc1YaGeliImselNerilerComponent implements OnInit, AfterViewInit {
  title = '1 yaş Gelişimsel öneriler';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM ÖNERİLERİ İPUÇLARI VE ETKİNLİKLER: 2 Yaşındaki Çocuğunuz İçin Neler Yapabilirsiniz? Çocuğunuzun ilk öğretmen…";
