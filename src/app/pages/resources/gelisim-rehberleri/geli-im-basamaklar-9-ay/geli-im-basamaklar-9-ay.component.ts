...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-9-ay.component.html',
  styleUrl: './geli-im-basamaklar-9-ay.component.css'
})
export class GeliImBasamaklar9AyComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 9. Ay ';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM BASAMAKLARI: BEBEĞİNİZİN 9. AYI Bebeğinizin gelişim sürecinde bazı önemli kilometre taşları vardır. Bebeğini…";
