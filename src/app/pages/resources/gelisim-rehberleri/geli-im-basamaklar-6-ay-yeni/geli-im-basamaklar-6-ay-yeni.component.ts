...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-6-ay-yeni.component.html',
  styleUrl: './geli-im-basamaklar-6-ay-yeni.component.css'
})
export class GeliImBasamaklar6AyYeniComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 6. Ay (Yeni)';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM BASAMAKLARI: BEBEĞİNİZİN 6. AYI Bebeğinizin gelişim sürecinde bazı önemli kilometre taşları vardır. Bebeğini…";
