...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-4-ya.component.html',
  styleUrl: './geli-im-basamaklar-4-ya.component.css'
})
export class GeliImBasamaklar4YaComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 4. Yaş ';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM BASAMAKLARI: 4 YAŞ ÇOCUĞUNUZ Çocuğunuzun gelişim sürecinde bazı önemli kilometre taşları vardır. Çocuğunuzun…";
