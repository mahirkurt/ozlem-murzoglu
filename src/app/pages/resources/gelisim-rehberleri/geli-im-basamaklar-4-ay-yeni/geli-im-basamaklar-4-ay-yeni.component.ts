...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-4-ay-yeni.component.html',
  styleUrl: './geli-im-basamaklar-4-ay-yeni.component.css'
})
export class GeliImBasamaklar4AyYeniComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 4. Ay (Yeni)';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM BASAMAKLARI: BEBEĞİNİZİN 4. AYI Bebeğinizin gelişim sürecinde bazı önemli kilometre taşları vardır. Bebeğini…";
