...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-2-ay.component.html',
  styleUrl: './geli-im-basamaklar-2-ay.component.css'
})
export class GeliImBasamaklar2AyComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 2. Ay';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ÇOCUK GELİŞİM BASAMAKLARI: BEBEĞİNİZİN 2. AYI BEBEĞİNİZİN ADI DOĞUM TARİHİ BUGÜNÜN TARİHİ Çocuğunuzun nasıl oynadığı…";
