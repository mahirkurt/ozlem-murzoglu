...
@Component({
  ...
  templateUrl: './4-ya-geli-imsel-neriler.component.html',
  styleUrl: './4-ya-geli-imsel-neriler.component.css'
})
export class Doc4YaGeliImselNerilerComponent implements OnInit, AfterViewInit {
  title = '4 Yaş Gelişimsel Öneriler';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM ÖNERİLERİ İPUÇLARI VE ETKİNLİKLER: 4 Yaşındaki Çocuğunuz İçin Neler Yapabilirsiniz? Çocuğunuzun ilk öğretmen…";
