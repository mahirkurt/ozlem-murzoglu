...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-2-ay-yeni.component.html',
  styleUrl: './geli-im-basamaklar-2-ay-yeni.component.css'
})
export class GeliImBasamaklar2AyYeniComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 2. Ay (Yeni)';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM BASAMAKLARI: BEBEĞİNİZİN 2. AYI Bebeğinizin gelişim sürecinde bazı önemli kilometre taşları vardır. Bebeğini…";
