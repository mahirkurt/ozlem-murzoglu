...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-4-ay.component.html',
  styleUrl: './geli-im-basamaklar-4-ay.component.css'
})
export class GeliImBasamaklar4AyComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 4. Ay';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ÇOCUK GELİŞİM BASAMAKLARI: BEBEĞİNİZİN 4. AYI BEBEĞİNİZİN ADI DOĞUM TARİHİ BUGÜNÜN TARİHİ Çocuğunuzun nasıl oynadığı…";
