...
@Component({
  ...
  templateUrl: './geli-im-pu-lar-ve-etkinlikleri-4-ya.component.html',
  styleUrl: './geli-im-pu-lar-ve-etkinlikleri-4-ya.component.css'
})
export class GeliImPuLarVeEtkinlikleri4YaComponent implements OnInit, AfterViewInit {
  title = 'Gelişim İpuçları ve Etkinlikleri - 4. Yaş ';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM İPUÇLARI VE ETKİNLİKLER: 4 YAŞ ÇOCUĞUNUZ Çocuğunuzun ilk öğretmeni olarak, onun öğrenmesine ve beyin gelişim…";
