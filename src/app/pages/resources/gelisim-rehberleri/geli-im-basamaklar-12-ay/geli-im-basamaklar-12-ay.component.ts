...
@Component({
  ...
  templateUrl: './geli-im-basamaklar-12-ay.component.html',
  styleUrl: './geli-im-basamaklar-12-ay.component.css'
})
export class GeliImBasamaklar12AyComponent implements OnInit, AfterViewInit {
  title = 'Gelişim Basamakları - 12. Ay ';
  category = 'Gelişim Rehberleri';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ GELİŞİM BASAMAKLARI: ÇOCUĞUNUZUN 12. AYI Çocuğunuzun gelişim sürecinde bazı önemli kilometre taşları vardır. Bunlar …";
