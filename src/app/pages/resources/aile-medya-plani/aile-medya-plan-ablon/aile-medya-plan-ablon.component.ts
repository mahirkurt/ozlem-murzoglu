...
@Component({
  selector: 'app-aile-medya-plan-ablon',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './aile-medya-plan-ablon.component.html',
  styleUrl: './aile-medya-plan-ablon.component.css'
})
export class AileMedyaPlanAblonComponent implements OnInit, AfterViewInit {
  title = 'Aile Medya Planı Şablon';
  category = 'Aile Medya Planı';
  description: string = "DENGELİ BİR DİJİTAL YAŞAM İÇİN AİLE MEDYA KULLANIM PLANI Medya her yerdedir ve bunu yönetmek zor olabilir. \"Aile Medya Kullanım Planı\" oluşturmak aileniz için medya önceliklerini …";
