...
@Component({
  selector: 'app-ergenlik-d-nemi-b-y-k-de-i-imlere-haz-r-ol',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './ergenlik-d-nemi-b-y-k-de-i-imlere-haz-r-ol.component.html',
  styleUrl: './ergenlik-d-nemi-b-y-k-de-i-imlere-haz-r-ol.component.css'
})
export class ErgenlikDNemiBYKDeIImlereHazROlComponent implements OnInit, AfterViewInit {
  title = 'ERGENLİK DÖNEMİ: BÜYÜK DEĞİŞİMLERE HAZIR OL';
  category = 'Bright Futures (Çocuk)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ ERGENLÌK DÖNEMÌ BÜYÜK DEĞİŞİMLERE HAZIR OL! Ergenlik, vücudunun bir çocuktan bir yetişkine dönüşmeye başladığı dönemdir. Bazen vücudunun tamamen kontro…";
