...
@Component({
  selector: 'app-gen-ergene-doktorundan-mektup',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './gen-ergene-doktorundan-mektup.component.html',
  styleUrl: './gen-ergene-doktorundan-mektup.component.css'
})
export class GenErgeneDoktorundanMektupComponent implements OnInit, AfterViewInit {
  title = 'GENÇ ERGENE DOKTORUNDAN MEKTUP';
  category = 'Bright Futures (Çocuk)';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU GENÇ ERGENE DOKTORUNDAN MEKTUP Artık yetişkinlik dönemine yaklaşıyorsun ve çocuklukta olduğundan farklı sağlık ihtiyaçların var. Bununla birlikte, doktorun …";
