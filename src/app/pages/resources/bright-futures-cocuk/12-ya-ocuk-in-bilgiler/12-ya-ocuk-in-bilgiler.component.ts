...
@Component({
  selector: 'app-12-ya-ocuk-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './12-ya-ocuk-in-bilgiler.component.html',
  styleUrl: './12-ya-ocuk-in-bilgiler.component.css'
})
export class Doc12YaOcukInBilgilerComponent implements OnInit, AfterViewInit, OnDestroy {
  title = '12. Yaş - Çocuk İçin Bilgiler';
  category = 'Bright Futures (Çocuk)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ DOKTORUMDAN ÖNERÌLER 12. YAŞ ZİYARETİ HAYAT NASIL GİDİYOR? Ailenle vakit geçirmenin tadını çıkar. Ev işlerine yardım etmenin yollarını ara. Ailenin kur…";
