...
@Component({
  selector: 'app-17-ya-ocuk-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './17-ya-ocuk-in-bilgiler.component.html',
  styleUrl: './17-ya-ocuk-in-bilgiler.component.css'
})
export class Doc17YaOcukInBilgilerComponent implements OnInit, AfterViewInit {
  title = '17. YAŞ ZİYARETİ';
  category = 'Bright Futures (Çocuk)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ DOKTORUMDAN ÖNERÌLER 17. YAŞ ZİYARETİ HAYAT NASIL GİDİYOR? Ailenle vakit geçirmenin tadını çıkar. Onlara evde yardımcı olabileceğin yollar arayın. Soru…";
