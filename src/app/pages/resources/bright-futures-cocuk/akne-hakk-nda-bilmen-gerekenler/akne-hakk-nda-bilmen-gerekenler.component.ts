...
@Component({
  selector: 'app-akne-hakk-nda-bilmen-gerekenler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './akne-hakk-nda-bilmen-gerekenler.component.html',
  styleUrl: './akne-hakk-nda-bilmen-gerekenler.component.css'
})
export class AkneHakkNdaBilmenGerekenlerComponent implements OnInit, AfterViewInit {
  title = 'AKNE HAKKINDA BİLMEN GEREKENLER';
  category = 'Bright Futures (Çocuk)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AKNE (SİVİLCELER) NASIL KONTROL ALTINA ALINIR? Hemen hemen tüm gençlerde sivilce veya kara noktalar gelişir. Durumun ister hafif ister şiddetli olsun, …";
