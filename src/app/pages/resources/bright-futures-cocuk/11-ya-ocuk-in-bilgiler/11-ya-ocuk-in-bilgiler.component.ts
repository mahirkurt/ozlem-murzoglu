...
export class Doc11YaOcukInBilgilerComponent implements OnInit, AfterViewInit {
  docAssetPath = '/assets/resources/docs/bright-futures-cocuk/11-ya-ocuk-in-bilgiler.json';
