...
@Component({
  selector: 'app-13-ya-ocuk-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './13-ya-ocuk-in-bilgiler.component.html',
  styleUrl: './13-ya-ocuk-in-bilgiler.component.css'
})
export class Doc13YaOcukInBilgilerComponent implements OnInit, AfterViewInit, OnDestroy {
  title = '13. Yaş - Çocuk İçin Bilgiler';
  category = 'Bright Futures (Çocuk)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ DOKTORUMDAN ÖNERÌLER 13. YAŞ ZİYARETİ HAYAT NASIL GİDİYOR? Ailenle vakit geçirmenin tadını çıkar. Ev işlerine yardım etmenin yollarını ara. Ailenin kur…";
