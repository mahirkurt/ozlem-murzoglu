...
@Component({
  ...
  templateUrl: './antibiyotikler.component.html',
  styleUrl: './antibiyotikler.component.css'
})
export class AntibiyotiklerComponent implements OnInit, AfterViewInit {
  title = 'Antibiyotikler';
  category = 'Hastalıklar';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ANTİBİYOTİKLER HAKKINDA BİLMENİZ GEREKENLER Antibiyotikler hayat kurtarır. Antibiyotikleri kullanma şeklimizi iyileş…";
