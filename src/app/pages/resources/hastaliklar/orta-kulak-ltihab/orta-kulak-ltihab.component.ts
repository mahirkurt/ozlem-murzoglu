...
@Component({
  ...
  templateUrl: './orta-kulak-ltihab.component.html',
  styleUrl: './orta-kulak-ltihab.component.css'
})
export class OrtaKulakLtihabComponent implements OnInit, AfterViewInit {
  title = 'Orta Kulak İltihabı';
  category = 'Hastalıklar';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ÇOCUKLARDA ORTA KULAK İLTİHABI Orta kulak iltihabı, çocuklarda yaygın bir sorundur. Gelişmiş ülkelerdeki bebeklerin …";
