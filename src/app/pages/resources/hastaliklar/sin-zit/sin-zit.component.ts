...
@Component({
  ...
  templateUrl: './sin-zit.component.html',
  styleUrl: './sin-zit.component.css'
})
export class SinZitComponent implements OnInit, AfterViewInit {
  title = 'Sinüzit';
  category = 'Hastalıklar';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ÇOCUKLARDA SİNÜZİT Çocuklarda sinüzit (rinosinüzit) yetişkinlerdeki sinüzitten farklıdır. Çocuklarda öksürük, ağız k…";
