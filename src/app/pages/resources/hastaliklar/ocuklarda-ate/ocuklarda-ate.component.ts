...
@Component({
  ...
  templateUrl: './ocuklarda-ate.component.html',
  styleUrl: './ocuklarda-ate.component.css'
})
export class OcuklardaAteComponent implements OnInit, AfterViewInit {
  title = 'Çocuklarda Ateş';
  category = 'Hastalıklar';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ÇOCUKLARDA YÜKSEK ATEŞ Ateş, başta enfeksiyon olmak üzere vücut tarafından farklı koşullara verilen bir tepkidir. At…";
