...
@Component({
  ...
  templateUrl: './ast-m-ataklar-ndan-korunma.component.html',
  styleUrl: './ast-m-ataklar-ndan-korunma.component.css'
})
export class AstMAtaklarNdanKorunmaComponent implements OnInit, AfterViewInit {
  title = 'Astım Ataklarından Korunma';
  category = 'Hastalıklar';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ TETİKLEYİCİLERİN KONTROLÜ İLE ASTIM ATAKLARINDAN KORUNMA Astım belirtilerini kötüleştiren şeylere astım tetikleyicil…";
