...
@Component({
  ...
  templateUrl: './bademcik-ltihab.component.html',
  styleUrl: './bademcik-ltihab.component.css'
})
export class BademcikLtihabComponent implements OnInit, AfterViewInit {
  title = 'Bademcik İltihabı';
  category = 'Hastalıklar';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ ÇOCUKLARDA BADEMCİK İLTİHABI Tonsillit ya da farenjit olarak da adlandırılan bademcik iltihabı, boğazın yan duvarlar…";
