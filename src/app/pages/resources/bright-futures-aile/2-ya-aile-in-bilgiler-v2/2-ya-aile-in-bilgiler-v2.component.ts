...
export class Doc2YaAileInBilgilerV2Component implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 2½ YAŞ ZİYARETİ AİLE RUTİNLERİ Ailenizle birlikte yemek masası birlikteliğinin tadını çıkarın ve çocuğunuzu yemeklere her zaman d…";
