...
@Component({
  selector: 'app-12-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './12-ya-aile-in-bilgiler.component.html',
  styleUrl: './12-ya-aile-in-bilgiler.component.css'
})
export class Doc12YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '12. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 12. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
