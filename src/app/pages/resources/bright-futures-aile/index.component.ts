...
@Component({
  ...
  `]
    ...
    export class BrightFuturesAileCategoryComponent implements OnInit {
      ...
      ngOnInit(): void {
        const pageTitle = 'Bright Futures (Aile) | Kaynaklar | Özlem Mürzoğlu';
        this.title.setTitle(pageTitle);
        this.meta.updateTag({ name: 'description', content: 'Bright Futures (Aile) kategorisindeki kaynaklar' });
      }
    }
