...
@Component({
  selector: 'app-15-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './15-ya-aile-in-bilgiler.component.html',
  styleUrl: './15-ya-aile-in-bilgiler.component.css'
})
export class Doc15YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '15. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 15. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
