...
export class Doc15YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 15. YAŞ ZİYARETİ AİLENİZİN DURUMU Ergeninizle birlikte olmak için zaman ayırın ve onun umutlarını ve endişelerini ilgiyle dinleyi…";
