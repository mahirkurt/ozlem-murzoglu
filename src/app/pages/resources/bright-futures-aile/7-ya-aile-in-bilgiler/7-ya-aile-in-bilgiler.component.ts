...
@Component({
  selector: 'app-7-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './7-ya-aile-in-bilgiler.component.html',
  styleUrl: './7-ya-aile-in-bilgiler.component.css'
})
export class Doc7YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '7. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 7. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
