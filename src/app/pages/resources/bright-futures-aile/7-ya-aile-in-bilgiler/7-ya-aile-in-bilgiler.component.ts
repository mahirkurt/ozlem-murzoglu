...
export class Doc7YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 7. YAŞ ZİYARETİ AİLENİZİN DURUMU Çocuğunuzu bağımsız ve sorumlu olmaya teşvik edin. Ona sarılın ve övün. Çocuğunuzla zaman geçiri…";
