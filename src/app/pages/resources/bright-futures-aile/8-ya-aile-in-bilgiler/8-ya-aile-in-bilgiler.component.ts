...
@Component({
  selector: 'app-8-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './8-ya-aile-in-bilgiler.component.html',
  styleUrl: './8-ya-aile-in-bilgiler.component.css'
})
export class Doc8YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '8. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 8. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
