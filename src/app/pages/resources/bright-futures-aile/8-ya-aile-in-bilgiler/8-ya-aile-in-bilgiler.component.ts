...
export class Doc8YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 8. YAŞ ZİYARETİ AİLENİZİN DURUMU Çocuğunuzu bağımsız ve sorumluluk sahibi olması için destekleyin/cesaretlendirin. Çocuğunuzla va…";
