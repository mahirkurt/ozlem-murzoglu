...
@Component({
  selector: 'app-12-ay-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './12-ay-aile-in-bilgiler.component.html',
  styleUrl: './12-ay-aile-in-bilgiler.component.css'
})
export class Doc12AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '12. AY ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 12. AY ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
