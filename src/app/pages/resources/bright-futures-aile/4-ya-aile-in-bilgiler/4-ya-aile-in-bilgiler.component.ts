...
@Component({
  selector: 'app-4-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './4-ya-aile-in-bilgiler.component.html',
  styleUrl: './4-ya-aile-in-bilgiler.component.css'
})
export class Doc4YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '4. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 4. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
