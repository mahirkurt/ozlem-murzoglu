...
@Component({
  selector: 'app-6-ay-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './6-ay-aile-in-bilgiler.component.html',
  styleUrl: './6-ay-aile-in-bilgiler.component.css'
})
export class Doc6AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '6. AY ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 6. AY ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
