...
export class Doc18AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 18. AY ZİYARETİ ÇOCUĞUNUZUN DAVRANIŞLARI Çocuğunuzun yeni ortamlarda ve durumlarda size yapışmasını veya yabancıların yanında kay…";
