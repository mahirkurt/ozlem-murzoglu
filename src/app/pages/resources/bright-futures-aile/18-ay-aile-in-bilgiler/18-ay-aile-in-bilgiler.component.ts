...
@Component({
  selector: 'app-18-ay-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './18-ay-aile-in-bilgiler.component.html',
  styleUrl: './18-ay-aile-in-bilgiler.component.css'
})
export class Doc18AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '18. AY ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 18. AY ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
