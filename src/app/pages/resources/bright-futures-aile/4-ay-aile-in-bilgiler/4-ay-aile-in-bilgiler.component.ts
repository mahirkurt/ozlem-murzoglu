...
@Component({
  selector: 'app-4-ay-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './4-ay-aile-in-bilgiler.component.html',
  styleUrl: './4-ay-aile-in-bilgiler.component.css'
})
export class Doc4AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '4. AY ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 4. AY ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
