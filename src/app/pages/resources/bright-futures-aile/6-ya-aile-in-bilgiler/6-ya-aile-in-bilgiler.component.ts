...
export class Doc6YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 6. YAŞ ZİYARETİ AİLENİZİN DURUMU Çocuğunuzla zaman geçirin. Onu sık sık kucaklayın ve iyi şeyler yaptığında övün. Çocuğunuzun ken…";
