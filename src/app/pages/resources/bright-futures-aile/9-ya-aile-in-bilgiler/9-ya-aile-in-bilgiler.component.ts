...
export class Doc9YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 9. YAŞ ZİYARETİ AİLENİZİN DURUMU Çocuğunuzu bağımsız ve sorumlu olmaya teşvik edin. Ona sık sık sarılın ve onu övün. Çocuğunuzla …";
