...
@Component({
  selector: 'app-11-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './11-ya-aile-in-bilgiler.component.html',
  styleUrl: './11-ya-aile-in-bilgiler.component.css'
})
export class Doc11YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '11. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 11. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
