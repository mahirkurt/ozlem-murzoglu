...
@Component({
  selector: 'app-9-ay-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './9-ay-aile-in-bilgiler.component.html',
  styleUrl: './9-ay-aile-in-bilgiler.component.css'
})
export class Doc9AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '9. AY ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 9. AY ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
