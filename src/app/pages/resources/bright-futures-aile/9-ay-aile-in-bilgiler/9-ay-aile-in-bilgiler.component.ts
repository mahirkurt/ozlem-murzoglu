...
export class Doc9AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 9. AY ZİYARETİ AİLENİZİN DURUMU Arkadaşlarınızla ve ailenizle iletişim halinde olun. Arkadaşlarınızı evinize davet edin veya bir …";
