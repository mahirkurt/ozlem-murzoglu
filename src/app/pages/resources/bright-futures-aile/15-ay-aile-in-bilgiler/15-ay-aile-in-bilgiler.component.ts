...
export class Doc15AyAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 15. AY ZİYARETİ İLETİŞİM Çocuğunuza seçimler yapması için fırsatlar verin. Mesela çocuğunuzun muz veya elma gibi iki iyi seçenek …";
