...
export class Doc5YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  ...
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AİLENİZ İÇİN BİLGİLER 5. YAŞ ZİYARETİ AİLENİZİN DURUMU Çocuğunuzla zaman geçirin. Onu sık sık kucaklayın ve iyi şeyler yaptığında övün. Çocuğunuzun ken…";
