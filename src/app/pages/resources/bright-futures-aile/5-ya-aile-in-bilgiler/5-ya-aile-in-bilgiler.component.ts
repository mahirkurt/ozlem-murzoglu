...
@Component({
  selector: 'app-5-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './5-ya-aile-in-bilgiler.component.html',
  styleUrl: './5-ya-aile-in-bilgiler.component.css'
})
export class Doc5YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '5. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 5. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
