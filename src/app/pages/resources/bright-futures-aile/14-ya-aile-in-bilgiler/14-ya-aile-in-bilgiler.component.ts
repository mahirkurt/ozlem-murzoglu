...
@Component({
  selector: 'app-14-ya-aile-in-bilgiler',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './14-ya-aile-in-bilgiler.component.html',
  styleUrl: './14-ya-aile-in-bilgiler.component.css'
})
export class Doc14YaAileInBilgilerComponent implements OnInit, AfterViewInit {
  title = '14. YAŞ ZİYARETİ';
  category = 'Bright Futures (Aile)';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BRIGHT FUTURES PROGRAMI 14. YAŞ ZİYARETİ BİLGİ FÖYÜ EVİNİZİN DURUMU Sigara içmeyin veya elektronik sigara kullanmayın. Evinizi ve arabanızı dumansız tutu…";
