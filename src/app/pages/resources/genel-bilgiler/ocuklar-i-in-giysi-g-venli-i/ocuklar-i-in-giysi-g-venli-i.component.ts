...
@Component({
  selector: 'app-ocuklar-i-in-giysi-g-venli-i',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './ocuklar-i-in-giysi-g-venli-i.component.html',
  styleUrl: './ocuklar-i-in-giysi-g-venli-i.component.css'
})
export class OcuklarIInGiysiGVenliIComponent implements OnInit, AfterViewInit {
  title = 'Çocuklar için Giysi Güvenliği';
  category = 'Genel Bilgiler';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ BEBEK VE ÇOCUKLAR İÇİN KIYAFET GÜVENLİĞİ Kıyafetler, takılar ve aksesuarlar bir bebeğin veya küçük çocuğun solunum y…";
