...
@Component({
  selector: 'app-b-cek-kovucular',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './b-cek-kovucular.component.html',
  styleUrl: './b-cek-kovucular.component.css'
})
export class BCekKovucularComponent implements OnInit, AfterViewInit {
  title = 'Böcek Kovucular';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ ÇOCUĞUNUZ İÇİN BÖCEK KOVUCU SEÇİMİ Sıcak havalar, çocukların aileleri ve arkadaşlarıyla oynamak, yürüyüş yapmak ve temiz havanın tadını çıkarmak için d…";
