...
@Component({
  selector: 'app-beslenme-g-venli-i',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './beslenme-g-venli-i.component.html',
  styleUrl: './beslenme-g-venli-i.component.css'
})
export class BeslenmeGVenliIComponent implements OnInit, AfterViewInit {
  title = 'Beslenme Güvenliği';
  category = 'Genel Bilgiler';
  description: string = "İRLANDA ULUSAL SAĞLIK HİZMETLERİ KURUMU BESLENME GÜVENLİĞİ ÇOCUKLARDA BOĞULMAYI ÖNLEME Bebekler ve çocukların nesneleri ağızlarına götürme konusunda doğal bir eğilimleri vardır. B…";
