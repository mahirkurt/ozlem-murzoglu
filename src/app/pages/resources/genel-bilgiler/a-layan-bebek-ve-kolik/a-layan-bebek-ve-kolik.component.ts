...
@Component({
  selector: 'app-a-layan-bebek-ve-kolik',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './a-layan-bebek-ve-kolik.component.html',
  styleUrl: './a-layan-bebek-ve-kolik.component.css'
})
export class ALayanBebekVeKolikComponent implements OnInit, AfterViewInit {
  title = 'Ağlayan Bebek ve Kolik';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ AĞLAYAN BEBEK VE KOLİK HAKKINDA BİLGİLER Bebekler farklı nedenlerle ağlarlar. Ağlamak, bebeklerin bize neye ihtiyaçları olduğunu söylemeye çalışmaların…";
