...
@Component({
  selector: 'app-araba-g-venlik-koltuklar',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './araba-g-venlik-koltuklar.component.html',
  styleUrl: './araba-g-venlik-koltuklar.component.css'
})
export class ArabaGVenlikKoltuklarComponent implements OnInit, AfterViewInit {
  title = 'Araba Güvenlik Koltukları';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ ARABA GÜVENLİK KOLTUKLARI Bir araba güvenlik koltuğunu doğru şekilde kullanmak büyük önem taşır. Çocuğunuzu bir çarpışmada uygun şekilde korumak için, …";
