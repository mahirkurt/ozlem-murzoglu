...
@Component({
  selector: 'app-alkol-kullan-m-ve-emzirme',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './alkol-kullan-m-ve-emzirme.component.html',
  styleUrl: './alkol-kullan-m-ve-emzirme.component.css'
})
export class AlkolKullanMVeEmzirmeComponent implements OnInit, AfterViewInit {
  title = 'Alkol Kullanımı ve Emzirme';
  category = 'Genel Bilgiler';
  description: string = "UZM.DR. ÖZLEM MURZOĞLU - ÇOCUK SAĞLIĞI VE HASTALIKLARI KLİNİĞİ EMZİREN ANNELER ALKOL TÜKETEBİLİR Mİ? Emzirirken Alkol Tüketiminin Etkileri Kadınlar, anne karnındaki bir çocuğa zar…";
