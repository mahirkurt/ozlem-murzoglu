...
@Component({
  selector: 'app-yenido-an-s-nneti',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './yenido-an-s-nneti.component.html',
  styleUrl: './yenido-an-s-nneti.component.css'
})
export class YenidoAnSNnetiComponent implements OnInit, AfterViewInit {
  title = 'Yenidoğan Sünneti';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ ERKEKLERDE YENİDOĞAN SÜNNETİ Ebeveynler, tıbbi, dini, kültürel ve etnik geleneklere ve kişisel nedenlere dayalı olarak yenidoğan sünneti hakkında farkl…";
