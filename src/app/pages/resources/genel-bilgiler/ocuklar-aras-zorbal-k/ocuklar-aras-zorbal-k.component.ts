...
@Component({
  selector: 'app-ocuklar-aras-zorbal-k',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './ocuklar-aras-zorbal-k.component.html',
  styleUrl: './ocuklar-aras-zorbal-k.component.css'
})
export class OcuklarArasZorbalKComponent implements OnInit, AfterViewInit {
  title = 'Çocuklar Arası Zorbalık';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ ÇOCUKLAR ARASI ZORBALIK Zorbalık, bir çocuğun başka bir çocuğa tekrar tekrar saldırmasıdır. Genellikle zorbalığa uğrayan çocuklar ya daha zayıf ya da d…";
