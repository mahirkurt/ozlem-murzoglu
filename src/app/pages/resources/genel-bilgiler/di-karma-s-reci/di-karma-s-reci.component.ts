...
@Component({
  selector: 'app-di-karma-s-reci',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './di-karma-s-reci.component.html',
  styleUrl: './di-karma-s-reci.component.css'
})
export class DiKarmaSReciComponent implements OnInit, AfterViewInit {
  title = 'Diş Çıkarma Süreci';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ BEBEKLER VE ÇOCUKLARDA DİŞ ÇIKARMA SÜRECİ Bebeklerin hayatındaki önemli dönemlerden biri, diş çıkarma sürecidir. Bu dönem, genellikle bebeklerin 6. ayı…";
