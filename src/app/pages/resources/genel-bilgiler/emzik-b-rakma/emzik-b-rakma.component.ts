...
@Component({
  ...
  templateUrl: './emzik-b-rakma.component.html',
  styleUrls: ['../../resource-enhanced-styles.scss']
})
export class EmzikBRakmaComponent implements OnInit, AfterViewInit {
  docAssetPath = '/assets/resources/docs/genel-bilgiler/emzik-b-rakma.json';
