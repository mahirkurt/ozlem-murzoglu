...
@Component({
  ...
  templateUrl: './g-venli-uyku-ve-bebe-iniz-ani-bebek-l-m-sendromu.component.html',
  styleUrl: './g-venli-uyku-ve-bebe-iniz-ani-bebek-l-m-sendromu.component.css'
})
export class GVenliUykuVeBebeInizAniBebekLMSendromuComponent implements OnInit, AfterViewInit {
  title = 'Güvenli Uyku ve Bebeğiniz - Ani Bebek Ölümü Sendromu';
  category = 'Genel Bilgiler';
  description: string = "AMERİKAN PEDİATRİ AKADEMİSİ GÜVENLİ UYKU VE BEBEĞİNİZ: ANİ BEBEK ÖLÜMÜ SENDROMU VE BOĞULMA RİSKİ NASIL AZALTILABİLİR? Her yıl binlerce bebek, güvenli olmayan uyku ortamları nedeni…";
