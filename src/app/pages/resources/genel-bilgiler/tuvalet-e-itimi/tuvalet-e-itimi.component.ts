...
@Component({
  ...
  templateUrl: './tuvalet-e-itimi.component.html',
  styleUrl: './tuvalet-e-itimi.component.css'
})
export class TuvaletEItimiComponent implements OnInit, AfterViewInit {
  title = 'Tuvalet Eğitimi';
  category = 'Genel Bilgiler';
  description: string = "KUZEY AMERİKA PEDİATRİK GASTROENTEROLOJİ, HEPATOLOJİ VE BESLENME DERNEĞİ TUVALET EĞİTİMİ İÇİN İPUÇLARI 18 Ay Tuvaleti uygun kelimelerle tanımlamaya başlayın: \"Kaka\", \"çiş\", \"lazım…";
