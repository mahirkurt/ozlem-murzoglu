...
const doctorPortalHostCanMatch = () => inject(HostContextService).isDoctorPortalHost();

export const routes: Routes = [
  { path: '', canMatch: [doctorPortalHostCanMatch], loadComponent: () => import('./pages/doctor-dashboard/doctor-dashboard.component').then(m => m.DoctorDashboardComponent), data: { animation: 'DoctorDashboard' } },
  ...
  { path: 'hizmetlerimiz/asi-takibi', loadComponent: () => import('./pages/services/asi-takibi/asi-takibi.component').then(m => m.AsiTakibiComponent), data: { animation: 'Vaccination' } },
  ...
  { path: 'kaynaklar/blog', loadComponent: () => import('./pages/blog/blog').then(m => m.BlogComponent), data: { animation: 'Blog' } },
  { path: 'kaynaklar/blog/:slug', loadComponent: () => import('./components/blog-article/blog-article.component').then(m => m.BlogArticleComponent), data: { animation: 'BlogArticle' } },
  { path: 'blog', redirectTo: 'kaynaklar/blog', pathMatch: 'full' },
  { path: 'blog/:slug', redirectTo: 'kaynaklar/blog/:slug', pathMatch: 'full' },
