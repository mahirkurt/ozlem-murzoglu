  ...
  template: `
    <div class="appointment-widget" [class.expanded]="isExpanded">
      ...
      <button 
        class="widget-button"
        (click)="toggleWidget()"
        [attr.aria-label]="(isExpanded ? 'APPOINTMENT.WIDGET.CLOSE_PANEL' : 'APPOINTMENT.WIDGET.OPEN_PANEL') | translate"
      >
        ...
        <span class="widget-text" *ngIf="!isExpanded">{{ 'APPOINTMENT.MODAL_TITLE' | translate }}</span>
      </button>

      <!-- Expanded Options -->
      <div class="widget-options" *ngIf="isExpanded">
        <div class="widget-header">
          <h3>{{ 'APPOINTMENT.WIDGET.QUICK_TITLE' | translate }}</h3>
          <p>{{ 'APPOINTMENT.WIDGET.QUICK_SUBTITLE' | translate }}</p>
        </div>
        ...
        <div class="widget-actions">
          ...
          >
            ...
            <div>
              <strong>{{ 'APPOINTMENT.MODAL_TITLE' | translate }}</strong>
              <small>{{ 'APPOINTMENT.WIDGET.GO_TO_SYSTEM' | translate }}</small>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <strong>{{ 'APPOINTMENT.WHATSAPP' | translate }}</strong>
              <small>{{ 'APPOINTMENT.WIDGET.QUICK_CONTACT' | translate }}</small>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <small>{{ 'APPOINTMENT.WIDGET.PHONE_APPOINTMENT' | translate }}</small>
            </div>
          </a>
        </div>
      </div>
...
export class AppointmentWidgetComponent {
  ...
  get whatsappUrl(): string {
    return CONTACT_HELPERS.getWhatsAppUrl(this.translate.instant('APPOINTMENT.WHATSAPP_MESSAGE'));
  }
